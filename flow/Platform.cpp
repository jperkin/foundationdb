...
#elif defined(__linux__) || defined(__FreeBSD__) || defined(__illumos__)
...
#if !defined(__linux__) && !defined(__APPLE__) && !defined(_WIN32) && !defined(__FreeBSD__) && !defined(__illumos__)
#error Port me!
#endif
