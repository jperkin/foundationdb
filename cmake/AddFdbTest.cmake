...
if(CMAKE_SYSTEM_NAME STREQUAL "SunOS")
  # cryptography has no illumos wheel and its Rust/maturin build is broken there;
  # inherit the pkgsrc-built module instead of having pip rebuild it.
  string(APPEND test_venv_cmd "${Python3_EXECUTABLE} -m venv --system-site-packages ${test_venv_dir} ")
else()
